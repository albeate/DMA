...
\subsubsection*{a}
Den returnerer True, da $x = 17$ er en del af listen. 
...
\section*{Del 2}
Tjekker hvorvidt $x$ eksistere blandt de først $n$ i listen, hvis ja så returnerer den True. Den returnerer False dels hvis $x$ ikke eksisterer i listen, men også når $hi$ er for lavt da den ikke når at køre igennem listen. Listen skal også være sorteret ellers giver den et tilfældigt svar. 
